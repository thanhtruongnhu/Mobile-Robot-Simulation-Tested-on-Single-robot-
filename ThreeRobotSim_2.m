...
waypoints = [2.00    1.00  1  2  ;  % If we have more robot for example 3 robots: robot 1 [column 1&2]...
...
for p_idx = 1: numel(tVec) % pose index          
        ...
        Robot_2 = DiffWheelKinematics_2(Robot_2,nb);          
        
%         viz([Robot(1).x(1);Robot(1).x(2);Robot(1).angle],waypoints)
